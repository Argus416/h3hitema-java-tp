...
<div class="w3-container">
    <h1 style="text-align: center"><spring:message code="page.country.title"/></h1>
    <div class="btns w3-margin-bottom">
        <a class="w3-button w3-green " href="<c:url value="/" />"><spring:message code="application.back"/></a>
    </div>
